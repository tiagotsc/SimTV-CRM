...
;(function($) {
	$.fn.scriptcam=function(options) {
		...
		return this.each(function() {
			...
			if (fileExists(dirSwf)) {
				swfobject.embedSWF(dirSwf, opts.id, newWidth, newHeight, '11.6', false, opts, params);
			}
			else {
				alert('scriptcam.swf not found, please check the path parameter');
			}
		});
	};
