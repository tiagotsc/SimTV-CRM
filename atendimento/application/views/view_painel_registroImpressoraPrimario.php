...
<body>
    ...
    <!--<a href="#" style="color: white;" onclick="jQuery('#cupomSenha').print({globalStyles : false});">Imprimir</a>-->
    <p style="font-size: 15px; font-weight: bold;" id="cupomSenha">
        <!--###### SIM TV ######<br/><br/>SENHA N. 10<br/><br/>AGUARDE O ATENDIMENTO-->
    </p>    
        ...
        $.ajax({
          ...
          success: function(res) {
            ...
            if(res['senha'] == false){
                ...
                $('#cupomSenha').css('display','block');
                $("#cupomSenha").html('###### SIM TV ######<br><br>SENHA N. '+res['senha']+'<br><br>AGUARDE O ATENDIMENTO');
                                            // Desativa o CSS defaut do print
                //jQuery('#cupomSenha').print({globalStyles : false});
                window.print();
                $('#cupomSenha').css('display','none');
