    ...
    <!-- FIM Modal Apaga registro de telecom -->
            ...
            <div class="col-lg-12">
                ...
                <div id="divMain">
                    <?php
                    	...
                    	echo form_open('perfil/pesquisarPerfil',$data);
                            ...
                            $botaoCadastrar = (in_array(10, $this->session->userdata('permissoes')))? "<a href='".base_url('perfil/fichaPerfil')."' class='linkDireita'>Cadastrar&nbsp<span class='glyphicon glyphicon-plus'></span></a>": '';
                ...
                foreach($perfis as $per){
                    ...
                    $botaoEditar = (in_array(10, $this->session->userdata('permissoes')))? '<a title="Editar" href="'.base_url('perfil/fichaPerfil/'.$per->cd_perfil).'" class="icone glyphicon glyphicon glyphicon-pencil"></a>': '';
                    $botaoExcluir = (in_array(11, $this->session->userdata('permissoes')))? '<a title="Apagar" href="#" onclick="apagarRegistro('.$per->cd_perfil.',\''.$per->nome_perfil.'\')" data-toggle="modal"  data-target="#apaga" class="icone glyphicon glyphicon glyphicon glyphicon-remove"></a>': '';
