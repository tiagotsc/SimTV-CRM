                ...
                <div id="divMain">
                    <?php
                    	...
                    	echo form_open('usuario/pesquisar',$data);
                            ...
                            $botaoCadastrar = (in_array(8, $this->session->userdata('permissoes')))? "<a href='".base_url('usuario/ficha')."' class='linkDireita'>Cadastrar&nbsp<span class='glyphicon glyphicon-plus'></span></a>": '';
